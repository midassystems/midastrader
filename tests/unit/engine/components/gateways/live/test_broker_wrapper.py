...
from midas.positions import EquityPosition, FuturePosition
...
class TestBrokerApp(unittest.TestCase):
    def setUp(self):
        ...
        # BrokerApp instance
        self.broker_app = BrokerApp(self.symbols_map)
    ...
    def test_process_account_updates(self):
        ...
        # Validate
        args = self.broker_app.notify.call_args[0]
        self.assertEqual(args[0], EventType.ACCOUNT_UPDATE)
        self.assertEqual(args[1], self.broker_app.account_info)
    ...
    def test_updatePortfolio(self):
        ...
        for key, value in test_data.items():
            ...
            self.assertEqual(args[1], self.symbols_map.get_id(key))
            self.assertEqual(args[2], positions[key])
    ...
    def test_execDetails(self):
        ...
        self.assertEqual(args[2], execution_data)
