...
from midas.engine.components.risk import BaseRiskModel, load_risk_class
...
class TestLoadStrategyClass(unittest.TestCase):
    ...
    def test_load_risk_class_success(
        ...
        # Test
        strategy_class = load_risk_class(
            "fake/path/to/module.py", "TestRiskModel"
        )
    ...
    @patch("importlib.util.spec_from_file_location")
    @patch("importlib.util.module_from_spec")
    def test_load_risk_class_class_not_found(
        self, mock_module_from_spec, mock_spec_from_file_location
    ):
    ...
    @patch("importlib.util.spec_from_file_location")
    @patch("importlib.util.module_from_spec")
    def test_load_risk_class_not_subclass(
        self, mock_module_from_spec, mock_spec_from_file_location
    ):
    ...
    @patch("importlib.util.spec_from_file_location")
    @patch("importlib.util.module_from_spec")
    def test_load_risk_class_invalid_module_path(
        self, mock_module_from_spec, mock_spec_from_file_location
    ):
