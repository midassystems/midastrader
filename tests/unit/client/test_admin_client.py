...
class TestSymbolDataMethods(unittest.TestCase):
    ...
    def test_update_security_type(self):
        ...
        response = self.client.update_security_type(
            old_response["id"], new_security_type
        )
    ...
    def test_update_contract_units(self):
        ...
        response = self.client.update_contract_units(
            old_response["id"], new_contract_units
        )
    ...
    def tearDownClass(cls):
        resources = [
            (
                "asset classes",
                cls.client.get_asset_classes,
                cls.client.delete_asset_class,
            ),
            (
                "security types",
                cls.client.get_security_types,
                cls.client.delete_security_type,
            ),
            ...
            (
                "contract units",
                cls.client.get_contract_units,
                cls.client.delete_contract_units,
            ),
        ]
...
class TestSymbolMethods(unittest.TestCase):
    ...
    def test_update_symbol(self):
        ...
        # Test
        equity.ticker = "Test9"
        response = self.client.update_symbol(
            symbol_id=old_response["id"], symbol=equity
        )
