...
#         # Test
#         new_contract_units = ContractUnits.METRIC_TON
...
#         response = self.client.get_symbol_by_ticker("AAPL")[0]
#         id = response['id']

#         # test 
#         self.client.delete_symbol(symbol_id=id)
...
#         self.assertIn(self.option.ticker,tickers)
#         self.assertIn(self.index.ticker,tickers)
...
class TestBacktestMethods(unittest.TestCase):
    ...
    def test_create_backtest(self):
        ...
        # validate
        self.assertEqual(response['static_stats'], self.mock_static_stats)
        print(response)
